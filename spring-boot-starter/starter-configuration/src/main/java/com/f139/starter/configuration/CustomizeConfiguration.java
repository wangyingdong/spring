package com.f139.starter.configuration;

import com.f139.starter.api.service.AddService;
import com.f139.starter.api.service.MinusService;
import com.f139.starter.service.AddServiceImpl;
import com.f139.starter.service.MinusServiceNotSupportNegativeImpl;
import com.f139.starter.service.MinusServiceSupportNegativeImpl;
...
public class CustomizeConfiguration {
    ...
    /**
     * 如果配置了com.f139.support.negative=true，
     * 就实例化MinusServiceSupportNegativeImpl
     *
     * @return
     */
    @Bean
    @ConditionalOnProperty(value = "com.f139.starter.support.minus", havingValue = "true")
    ...
    /**
     * 如果没有配置com.f139.support.negative=true，
